...
?>
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												...
												<tr>
													<td>Total Semua  </td>
													<td><input type="text" class="form-control" name="total" readonly value="<?php echo $total_bayar; ?>"></td>
											...
											<tr>
												<td>Kembali</td>
												<td><input type="text" class="form-control" readonly value="<?php echo $hitung; ?>"></td>
												<td></td>
												<td>
